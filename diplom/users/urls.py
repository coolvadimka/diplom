...
urlpatterns = [
    path('login/', views.LoginUser.as_view(), name='login'), #views.login_user
    path('logout/', views.logout_user, name='logout'), #LogoutView.as_view()
    ...
    path('register/', views.RegisterUser.as_view(), name='register'), #views.register
